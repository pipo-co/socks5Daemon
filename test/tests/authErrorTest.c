...
START_TEST (auth_error_test_core_on_write_success) {
    ...
    unsigned state = auth_error_on_write(key);
...
START_TEST (auth_error_test_core_on_write_current) {
...
Suite * auth_error_test_suite(void) {
    ...
    tcase_add_test(tc, auth_error_test_core_on_write_success);
    tcase_add_test(tc, auth_error_test_core_on_write_current);
