...
START_TEST (request_error_test_core_on_post_write_success) {
    ...
    unsigned state = request_error_on_post_write(key);
...
START_TEST (request_error_test_core_on_post_write_current) {
...
Suite * request_error_test_suite(void) {
    ...
    tcase_add_test(tc, request_error_test_core_on_post_write_success);
    tcase_add_test(tc, request_error_test_core_on_post_write_current);
